...
const styles = StyleSheet.create({
  ...
  profileCard: { backgroundColor: Colors.white, borderRadius: 30, padding: 25, borderWidth: 1, borderColor: Colors.border, alignItems: 'center' },
  restLogoContainer: { width: 80, height: 80, borderRadius: 40, padding: 5, backgroundColor: Colors.white, borderWidth: 1, borderColor: Colors.border, marginBottom: 15 },
  restLogo: { width: '100%', height: '100%', borderRadius: 35 },
  statusDot: { position: 'absolute', bottom: 5, right: 5, width: 16, height: 16, borderRadius: 8, backgroundColor: '#2ECC71', borderWidth: 3, borderColor: Colors.white },
  restName: { fontSize: 22, fontWeight: '800', color: Colors.text, marginBottom: 8 },
  badgeRow: { flexDirection: 'row', alignItems: 'center', marginBottom: 25 },
  restStatus: { backgroundColor: '#2ECC7115', paddingHorizontal: 10, paddingVertical: 4, borderRadius: 8, marginRight: 8 },
  restStatusText: { fontSize: 10, fontWeight: '800', color: '#2ECC71' },
  ratingBox: { flexDirection: 'row', alignItems: 'center' },
  ratingText: { fontSize: 14, fontWeight: '700', color: '#F1C40F' },
  statsRow: { flexDirection: 'row', width: '100%', justifyContent: 'space-between', paddingTop: 20, borderTopWidth: 1, borderTopColor: Colors.border },
