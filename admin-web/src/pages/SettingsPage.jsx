      ...
      <AdminLayout title="Điều khoản">
        <div className="max-w-4xl mx-auto space-y-8 pb-12">
          ...
          <div className="bg-[#FFF5F2] rounded-[32px] p-10 flex flex-col items-center justify-center text-center">
            ...
            <div className="text-[10px] font-black text-[#8C6B5D] uppercase tracking-widest mb-2">
              PHÁP LÝ & QUY ĐỊNH
            </div>
            <h1 className="text-4xl font-black text-[#5C3D2E] mb-3">
              Cam kết Vận hành Minh bạch
            </h1>
            <p className="text-sm font-medium text-[#8C6B5D]">
          ...
          <div className="bg-white rounded-[32px] p-10 shadow-sm border border-slate-50 space-y-12">
            ...
            <div>
              <div className="flex items-center gap-4 mb-6">
                <div className="w-8 h-8 rounded-full bg-[#FFF5F2] text-[#A04F2D] flex items-center justify-center font-black text-sm">
                  1
                </div>
                <h3 className="text-xl font-black text-[#5C3D2E]">
                  Giới thiệu
                </h3>
              </div>
              <p className="text-[#8C6B5D] leading-relaxed mb-6">
                Chào mừng bạn đến với hệ thống quản trị của chúng tôi. Bằng cách
                sử dụng ứng dụng này, bạn đồng ý tuân thủ các quy tắc và hướng
                dẫn vận hành được thiết lập để đảm bảo chất lượng dịch vụ ẩm
                thực tốt nhất cho người dùng.
              </p>
              <div className="bg-[#FFF5F2] border-l-4 border-[#A04F2D] p-6 rounded-r-2xl italic text-[#5C3D2E] font-medium leading-relaxed">
                "Mục tiêu của chúng tôi là tạo ra một hệ sinh thái ẩm thực kết
                nối giữa nhà hàng, tài xế và khách hàng một cách liền mạch."
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                <div className="bg-[#FFF5F2] p-8 rounded-3xl">
                  ...
                  <p className="text-sm text-[#8C6B5D] leading-relaxed">
                    Đảm bảo tính chính xác của dữ liệu nhà hàng và trạng thái
                ...
                <div className="bg-[#FFF5F2] p-8 rounded-3xl">
                  ...
                  <p className="text-sm text-[#8C6B5D] leading-relaxed">
                    Cung cấp thông tin thực đơn chính xác và cập nhật giá cả
                    minh bạch trên nền tảng.
                  </p>
                </div>
              </div>

              <div className="bg-[#FFEBE5] p-6 rounded-2xl text-[#D9534F] text-sm leading-relaxed">
                <span className="font-bold">Lưu ý:</span> Mọi hành vi gian lận
                dữ liệu hoặc cố tình làm sai lệch thông tin đơn hàng sẽ bị đình
                chỉ tài khoản quản trị ngay lập tức mà không cần báo trước.
              </div>
            </div>
          </div>
        </div>
  ...
  return (
    <AdminLayout title="Cài đặt hệ thống">
      <div className="max-w-5xl space-y-8">
        <div>
          <h2 className="text-3xl font-black text-[#5C3D2E] mb-2">
            Cài đặt hệ thống
          </h2>
          <p className="text-sm text-[#8C6B5D]">
            Tùy chỉnh và quản lý cấu hình vận hành của bạn.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="flex items-center justify-between bg-[#FFF5F2] p-4 rounded-2xl">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-[10px] font-bold text-[#8C6B5D] uppercase">
                      Ngôn ngữ ứng dụng
                    </div>
                    <div className="text-sm font-bold text-[#D9534F]">
                      Tiếng Việt
                    </div>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between bg-[#FFF5F2] p-4 rounded-2xl">
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-sm font-bold text-[#5C3D2E]">
                    Chế độ tối
                  </div>
                </div>
                {/* Toggle switch */}
          ...
          <div className="bg-[#FF7A50] rounded-[32px] p-8 text-white flex flex-col items-center justify-center text-center shadow-premium relative overflow-hidden">
            ...
            <h3 className="text-2xl font-black mb-1 relative z-10">
              Build 1.2.0
            </h3>
          ...
          <div className="md:col-span-2 bg-[#FFF5F2] rounded-[32px] p-8">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                >
                  <div
                    className={`w-4 h-4 bg-white rounded-full transition-transform duration-300 ${notifOrder ? "translate-x-6" : "translate-x-0"}`}
                  />
                </button>
              </div>
              <div className="flex items-center justify-between">
                ...
                >
                  <div
                    className={`w-4 h-4 bg-white rounded-full transition-transform duration-300 ${notifRevenue ? "translate-x-6" : "translate-x-0"}`}
                  />
                </button>
              </div>
              <div className="flex items-center justify-between">
                ...
                >
                  <div
                    className={`w-4 h-4 bg-white rounded-full transition-transform duration-300 ${notifSecurity ? "translate-x-6" : "translate-x-0"}`}
                  />
                </button>
              </div>
            </div>
          ...
          <div className="bg-[#FFEBE5] rounded-[32px] p-8 relative overflow-hidden">
            <Share2
              size={120}
              className="absolute -right-10 -bottom-10 text-[#FFD6C9] opacity-50 rotate-12"
            />
            <div className="relative z-10">
              ...
              <p className="text-xs text-[#8C6B5D] mb-6 leading-relaxed">
                Quản lý các cổng thanh toán, đơn vị vận chuyển bên thứ ba và các
                dịch vụ webhook.
              </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-4">
          ...
          >
            ...
            <ChevronRight
              className="text-[#8C6B5D] group-hover:translate-x-1 transition-transform"
              size={18}
            />
          </button>
